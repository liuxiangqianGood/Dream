 ...
 <script type="text/javascript">
        ...
        $(function () {
            ...
            datagrid = $("#dd").datagrid({
                url: 'menu_findmenu.action', //请求的数据源
                ...
                idField: 'mid', //主键
                columns: [[//显示的列
                {field: 'mid', title: '编号', width: 100, sortable: true,
                	 
                checkbox:true
                },
                 { field: 'mname', title: '菜单名字', width: 100, sortable: true,
                     editor: { type: 'validatebox', options: { required: true} }
                 },
                  { field: 'fid', title: '父菜单名字', width: 100,
                      editor: { type: 'validatebox', options: { required: true} }
                  },
                 { field: 'urlaction', title: 'urlAction', width: 100,
                     editor: { type: 'validatebox', options: { required: true} }
                 },
                   ]],
                ...
                onAfterEdit:function(rowIndex, rowData, changes) {
                    ...
                    $.ajax({
                 		//async : false,
                 		url:"menu_addmid.action",
                 		type:"POST",
                 		data:{
                 			
                 			"menu.mname":rowData.mname,
                 			"menu.fid":rowData.fid,
                 			"menu.describe":rowData.describe
                 		},
