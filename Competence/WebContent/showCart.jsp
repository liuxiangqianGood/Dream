 ...
 <script type="text/javascript">
        ...
        $(function () {
            ...
            datagrid = $("#dd").datagrid({
                url: 'cart_findcart.action', //请求的数据源
                ...
                {field: 'id', title: '编号', width: 100, sortable: true, 
                 ...
                 { field: 'name', title: '菜名', width: 100, sortable: true,
                    
                	editor: { type: 'validatebox', options: { required: true} }
                 },
                 
                  { field: 'Flavor', title: '口味', width: 100, sortable: true,
                	 editor: { type: 'validatebox', options: { required: true}}
                	},
                  { field: 'cnumber', title: '数量', width: 100, sortable: true,  
                	 editor: { type: 'validatebox', options: { required: true} }
                  }
                   ]],
                queryParams: { action: 'findcart' }, //查询参数
                toolbar: [
